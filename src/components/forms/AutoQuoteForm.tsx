...
export default function AutoQuoteForm({ t }: Props) {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    if (!stepValid) return;
    void submit([
      { label: L.section_personal, value: "", section: true },
