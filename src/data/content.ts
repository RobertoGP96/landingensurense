...
export const CONTENT: Record<"es" | "en", Translation> = {
  es: {
    ...
    forms: {
      ...
      error: `No pudimos enviar tu solicitud. Vuelve a intentarlo o llámanos al ${CONTACT.phone}.`,
      required: "Requerido",
      summary: "Resumen",
    },
    quote_extra: {
  ...
  en: {
    ...
    forms: {
      ...
      error: `We couldn't send your request. Please try again or call us at ${CONTACT.phone}.`,
      required: "Required",
      summary: "Summary",
    },
    quote_extra: {
